...
Crie e ative um ambiente virtual na pasta deste módulo:
...
Por segurança e simplicidade acadêmica, o envio de e-mail é simulado. Quando um alerta é gerado, o sistema cria um arquivo `.eml` em:
