...
TXT_PATH = BASE_DIR / "phases" / "fase01_bases_multimodais" / "frases_pacientes.txt"
CSV_PATH = BASE_DIR / "data" / "samples" / "mapa_conhecimento.csv"
OUTPUT_PATH = BASE_DIR / "data" / "processed" / "resultado_diagnostico.csv"
